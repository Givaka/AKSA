...
app.post('/api/schedule', async (req, res) => {
  ...
  await db.setSchedule(req.body.scheduleId, req.body.text, req.body.userId, req.body.serviceID, req.body.start_date, req.body.end_date)

  jobs.set(req.body.scheduleId, schedule.scheduleJob(new Date(req.body.date), () => {
