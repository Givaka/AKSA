...
var TuiError = class _TuiError {
  ...
  static {
    this.ɵfac = function TuiError_Factory(t) {
      return new (t || _TuiError)();
    };
  }
  static {
...
var TuiPlatform = class _TuiPlatform {
  ...
  static {
    this.ɵfac = function TuiPlatform_Factory(t) {
      return new (t || _TuiPlatform)();
    };
  }
  static {
...
var ScreenOrientationService = class _ScreenOrientationService extends Observable {
  ...
  static ɵfac = function ScreenOrientationService_Factory(t) {
    return new (t || _ScreenOrientationService)();
  };
...
var ViewportService = class _ViewportService extends Observable {
  ...
  static ɵfac = function ViewportService_Factory(t) {
    return new (t || _ViewportService)();
  };
  static ɵprov = ɵɵdefineInjectable({
...
var TuiVisualViewport = class _TuiVisualViewport {
  ...
  static {
    this.ɵfac = function TuiVisualViewport_Factory(t) {
      return new (t || _TuiVisualViewport)();
    };
  }
  static {
    this.ɵdir = ɵɵdefineDirective({
  ...
  static {
    this.ɵfac = /* @__PURE__ */ (() => {
      ...
      return function TuiPopupService_Factory(t) {
        return (ɵTuiPopupService_BaseFactory || (ɵTuiPopupService_BaseFactory = ɵɵgetInheritedFactory(_TuiPopupService)))(t || _TuiPopupService);
      };
    })();
  }
  static {
...
var TuiRoot = class _TuiRoot extends TuiPortals {
  ...
  static {
    this.ɵfac = function TuiRoot_Factory(t) {
      return new (t || _TuiRoot)();
    };
  }
  static {
    this.ɵcmp = ɵɵdefineComponent({
      type: _TuiRoot,
      selectors: [["tui-root"]],
      hostAttrs: ["data-tui-version", "4.30.0"],
      hostVars: 6,
      ...
      standalone: true,
      features: [ɵɵProvidersFeature([], [tuiAsPortal(TuiPopupService)]), ɵɵHostDirectivesFeature([TuiPlatform, TuiVisualViewport, TuiFontSize]), ɵɵInheritDefinitionFeature, ɵɵStandaloneFeature],
...
var TuiSurfaceStyles = class _TuiSurfaceStyles {
  static {
    this.ɵfac = function TuiSurfaceStyles_Factory(t) {
      return new (t || _TuiSurfaceStyles)();
    };
  }
  static {
    this.ɵcmp = ɵɵdefineComponent({
