...
var TuiReorder = class _TuiReorder {
  ...
  static {
    this.ɵfac = function TuiReorder_Factory(t) {
      return new (t || _TuiReorder)();
    };
  }
  static {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(TuiReorder, [{
    ...
    args: [{
      ...
      imports: [AsyncPipe, NgForOf, PolymorpheusOutlet, PolymorpheusTemplate, TuiButton, TuiIcon, TuiTiles],
...
function TuiTableThGroup_ng_container_1_ng_container_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵproperty("ngTemplateOutlet", headings_r2[key_r1] && headings_r2[key_r1].template || plain_r3)("ngTemplateOutletContext", ɵɵpureFunction1(2, _c7, key_r1));
  }
}
...
var TuiTableCaption = class _TuiTableCaption {
  static {
    this.ɵfac = function TuiTableCaption_Factory(t) {
      return new (t || _TuiTableCaption)();
    };
  }
  static {
    this.ɵcmp = ɵɵdefineComponent({
...
var TuiTableCell = class _TuiTableCell {
  ...
  static {
    this.ɵfac = function TuiTableCell_Factory(t) {
      return new (t || _TuiTableCell)();
    };
  }
  static {
...
var TuiStuck = class _TuiStuck {
  ...
  static {
    this.ɵfac = function TuiStuck_Factory(t) {
      return new (t || _TuiStuck)();
    };
  }
  static {
    this.ɵdir = ɵɵdefineDirective({
...
var TuiTableStyles = class _TuiTableStyles {
  static {
    this.ɵfac = function TuiTableStyles_Factory(t) {
      return new (t || _TuiTableStyles)();
    };
  }
  static {
    this.ɵcmp = ɵɵdefineComponent({
...
var TuiTableDirective = class _TuiTableDirective {
  ...
  updateSorterAndDirection(sorter) {
    if (this.sorter === sorter) {
      this.updateDirection(this.direction === TuiSortDirection.Asc ? TuiSortDirection.Desc : TuiSortDirection.Asc);
    } else {
  ...
  static {
    this.ɵfac = function TuiTableDirective_Factory(t) {
      return new (t || _TuiTableDirective)();
    };
  }
  static {
    this.ɵdir = ɵɵdefineDirective({
...
var TuiTableDirectionOrder = class _TuiTableDirectionOrder {
  ...
  static {
    this.ɵfac = function TuiTableDirectionOrder_Factory(t) {
      return new (t || _TuiTableDirectionOrder)();
    };
  }
  static {
    this.ɵdir = ɵɵdefineDirective({
...
var TuiTableHead = class _TuiTableHead {
  ...
  static {
    this.ɵfac = function TuiTableHead_Factory(t) {
      return new (t || _TuiTableHead)();
    };
  }
  static {
    this.ɵdir = ɵɵdefineDirective({
...
var TuiTableResized = class _TuiTableResized {
  ...
  static {
    this.ɵfac = function TuiTableResized_Factory(t) {
      return new (t || _TuiTableResized)();
    };
  }
  static {
    this.ɵdir = ɵɵdefineDirective({
...
var TuiTableTh = class _TuiTableTh {
  ...
  static {
    this.ɵfac = function TuiTableTh_Factory(t) {
      return new (t || _TuiTableTh)();
    };
  }
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      hostBindings: function TuiTableTh_HostBindings(rf, ctx) {
        if (rf & 2) {
          ɵɵstyleProp("min-width", ctx.width, "px")("width", ctx.width, "px")("max-width", ctx.width, "px");
...
var TuiTableSortable = class _TuiTableSortable {
  ...
  static {
    this.ɵfac = function TuiTableSortable_Factory(t) {
      return new (t || _TuiTableSortable)();
    };
  }
  static {
    this.ɵdir = ɵɵdefineDirective({
...
var TuiTableSortBy = class _TuiTableSortBy {
  ...
  static {
    this.ɵfac = function TuiTableSortBy_Factory(t) {
      return new (t || _TuiTableSortBy)();
    };
  }
  static {
    this.ɵdir = ɵɵdefineDirective({
...
var TuiTableThead = class _TuiTableThead {
  static {
    this.ɵfac = function TuiTableThead_Factory(t) {
      return new (t || _TuiTableThead)();
    };
  }
  static {
    this.ɵdir = ɵɵdefineDirective({
...
var TuiTableSortPipe = class _TuiTableSortPipe {
  ...
  static {
    this.ɵfac = function TuiTableSortPipe_Factory(t) {
      return new (t || _TuiTableSortPipe)();
    };
  }
  static {
...
var TuiTableTd = class _TuiTableTd {
  static {
    this.ɵfac = function TuiTableTd_Factory(t) {
      return new (t || _TuiTableTd)();
    };
  }
  static {
    this.ɵcmp = ɵɵdefineComponent({
...
var TuiTableTr = class _TuiTableTr {
  ...
  static {
    this.ɵfac = function TuiTableTr_Factory(t) {
      return new (t || _TuiTableTr)();
    };
  }
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      standalone: true,
      features: [ɵɵProvidersFeature([TUI_TABLE_PROVIDER, ResizeObserverService]), ɵɵStandaloneFeature],
      attrs: _c4,
      decls: 4,
      vars: 4,
...
var TuiTableTbody = class _TuiTableTbody {
  ...
  static {
    this.ɵfac = function TuiTableTbody_Factory(t) {
      return new (t || _TuiTableTbody)();
    };
  }
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      standalone: true,
      features: [ɵɵProvidersFeature(TUI_TABLE_PROVIDER), ɵɵStandaloneFeature],
      attrs: _c5,
      ngContentSelectors: _c1,
      decls: 2,
      vars: 2,
...
var TuiTableThGroup = class _TuiTableThGroup {
  ...
  static {
    this.ɵfac = function TuiTableThGroup_Factory(t) {
      return new (t || _TuiTableThGroup)();
    };
  }
  static {
    this.ɵcmp = ɵɵdefineComponent({
...
var TuiTable = [TuiTableDirective, TuiTableCaption, TuiTableTbody, TuiTableThGroup, TuiTableTh, TuiTableTd, TuiTableTr, TuiTableCell, TuiTableHead, TuiTableSortBy, TuiTableSortable, TuiTableThead, TuiTableResized, TuiTableSortPipe, TuiTableDirectionOrder];
...
var TuiTablePagination = class _TuiTablePagination {
  ...
  static {
    this.ɵfac = function TuiTablePagination_Factory(t) {
      return new (t || _TuiTablePagination)();
    };
  }
  static {
    this.ɵcmp = ɵɵdefineComponent({
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(TuiTablePagination, [{
    ...
    args: [{
      ...
      imports: [AsyncPipe, NgForOf, NgIf, PolymorpheusOutlet, PolymorpheusTemplate, TuiButton, TuiDataList, TuiDropdownDirective, TuiDropdownOpen, TuiIcon, TuiLink],
      changeDetection: ChangeDetectionStrategy.OnPush,
...
var TuiGenericFilter = class _TuiGenericFilter extends AbstractTuiTableFilter {
  ...
  static {
    this.ɵfac = /* @__PURE__ */ (() => {
      ...
      return function TuiGenericFilter_Factory(t) {
        return (ɵTuiGenericFilter_BaseFactory || (ɵTuiGenericFilter_BaseFactory = ɵɵgetInheritedFactory(_TuiGenericFilter)))(t || _TuiGenericFilter);
      };
    })();
  }
  static {
...
var TuiTableFiltersDirective = class _TuiTableFiltersDirective {
  ...
  static {
    this.ɵfac = function TuiTableFiltersDirective_Factory(t) {
      return new (t || _TuiTableFiltersDirective)();
    };
  }
  static {
    this.ɵdir = ɵɵdefineDirective({
...
var TuiTableFilterDirective = class _TuiTableFilterDirective {
  ...
  static {
    this.ɵfac = function TuiTableFilterDirective_Factory(t) {
      return new (t || _TuiTableFilterDirective)();
    };
  }
  static {
    this.ɵdir = ɵɵdefineDirective({
...
var TuiTableFiltersPipe = class _TuiTableFiltersPipe {
  ...
  static {
    this.ɵfac = function TuiTableFiltersPipe_Factory(t) {
      return new (t || _TuiTableFiltersPipe)();
    };
  }
  static {
    this.ɵpipe = ɵɵdefinePipe({
