  ...
  static {
    this.ɵfac = /* @__PURE__ */ (() => {
      ...
      return function TuiHintDriver_Factory(t) {
        return (ɵTuiHintDriver_BaseFactory || (ɵTuiHintDriver_BaseFactory = ɵɵgetInheritedFactory(_TuiHintDriver)))(t || _TuiHintDriver);
      };
    })();
  }
  static {
...
var TuiHintOptionsDirective = class _TuiHintOptionsDirective {
  ...
  static {
    this.ɵfac = function TuiHintOptionsDirective_Factory(t) {
      return new (t || _TuiHintOptionsDirective)();
    };
  }
  static {
    this.ɵdir = ɵɵdefineDirective({
  ...
  static {
    this.ɵfac = /* @__PURE__ */ (() => {
      ...
      return function TuiHintPosition_Factory(t) {
        return (ɵTuiHintPosition_BaseFactory || (ɵTuiHintPosition_BaseFactory = ɵɵgetInheritedFactory(_TuiHintPosition)))(t || _TuiHintPosition);
      };
    })();
  }
  static {
...
var TuiHintDirective = class _TuiHintDirective {
  ...
  static {
    this.ɵfac = function TuiHintDirective_Factory(t) {
      return new (t || _TuiHintDirective)();
    };
  }
  static {
    this.ɵdir = ɵɵdefineDirective({
  ...
  static {
    this.ɵfac = /* @__PURE__ */ (() => {
      ...
      return function TuiHintPointer_Factory(t) {
        return (ɵTuiHintPointer_BaseFactory || (ɵTuiHintPointer_BaseFactory = ɵɵgetInheritedFactory(_TuiHintPointer)))(t || _TuiHintPointer);
      };
    })();
  }
  static {
...
var TuiHintUnstyledComponent = class _TuiHintUnstyledComponent {
  ...
  static {
    this.ɵfac = function TuiHintUnstyledComponent_Factory(t) {
      return new (t || _TuiHintUnstyledComponent)();
    };
  }
  static {
...
var TuiHintComponent = class _TuiHintComponent {
  ...
  static {
    this.ɵfac = function TuiHintComponent_Factory(t) {
      return new (t || _TuiHintComponent)();
    };
  }
  static {
    this.ɵcmp = ɵɵdefineComponent({
  ...
  static {
    this.ɵfac = /* @__PURE__ */ (() => {
      ...
      return function TuiHintHost_Factory(t) {
        return (ɵTuiHintHost_BaseFactory || (ɵTuiHintHost_BaseFactory = ɵɵgetInheritedFactory(_TuiHintHost)))(t || _TuiHintHost);
      };
    })();
  }
  static {
...
//# sourceMappingURL=chunk-2C5Z4Q7S.js.map
