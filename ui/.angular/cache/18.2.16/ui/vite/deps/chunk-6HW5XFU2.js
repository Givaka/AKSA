  ...
  static {
    this.ɵfac = /* @__PURE__ */ (() => {
      ...
      return function GlobalEventPlugin_Factory(t) {
        return (ɵGlobalEventPlugin_BaseFactory || (ɵGlobalEventPlugin_BaseFactory = ɵɵgetInheritedFactory(_GlobalEventPlugin)))(t || _GlobalEventPlugin);
      };
    })();
  }
  static {
  ...
  static {
    this.ɵfac = /* @__PURE__ */ (() => {
      ...
      return function OptionsEventPlugin_Factory(t) {
        return (ɵOptionsEventPlugin_BaseFactory || (ɵOptionsEventPlugin_BaseFactory = ɵɵgetInheritedFactory(_OptionsEventPlugin)))(t || _OptionsEventPlugin);
      };
    })();
  }
  static {
  ...
  static {
    this.ɵfac = /* @__PURE__ */ (() => {
      ...
      return function PreventEventPlugin_Factory(t) {
        return (ɵPreventEventPlugin_BaseFactory || (ɵPreventEventPlugin_BaseFactory = ɵɵgetInheritedFactory(_PreventEventPlugin)))(t || _PreventEventPlugin);
      };
    })();
  }
  static {
...
var ResizePlugin = class _ResizePlugin extends AbstractEventPlugin {
  ...
  static {
    this.ɵfac = /* @__PURE__ */ (() => {
      ...
      return function ResizePlugin_Factory(t) {
        return (ɵResizePlugin_BaseFactory || (ɵResizePlugin_BaseFactory = ɵɵgetInheritedFactory(_ResizePlugin)))(t || _ResizePlugin);
      };
    })();
  }
  static {
  ...
  static {
    this.ɵfac = /* @__PURE__ */ (() => {
      ...
      return function SelfEventPlugin_Factory(t) {
        return (ɵSelfEventPlugin_BaseFactory || (ɵSelfEventPlugin_BaseFactory = ɵɵgetInheritedFactory(_SelfEventPlugin)))(t || _SelfEventPlugin);
      };
    })();
  }
  static {
  ...
  static {
    this.ɵfac = /* @__PURE__ */ (() => {
      ...
      return function SilentEventPlugin_Factory(t) {
        return (ɵSilentEventPlugin_BaseFactory || (ɵSilentEventPlugin_BaseFactory = ɵɵgetInheritedFactory(_SilentEventPlugin)))(t || _SilentEventPlugin);
      };
    })();
  }
  static {
  ...
  static {
    this.ɵfac = /* @__PURE__ */ (() => {
      ...
      return function StopEventPlugin_Factory(t) {
        return (ɵStopEventPlugin_BaseFactory || (ɵStopEventPlugin_BaseFactory = ɵɵgetInheritedFactory(_StopEventPlugin)))(t || _StopEventPlugin);
      };
    })();
  }
  static {
...
var ZonelessPlugin = class _ZonelessPlugin extends SilentEventPlugin {
  ...
  static {
    this.ɵfac = /* @__PURE__ */ (() => {
      ...
      return function ZonelessPlugin_Factory(t) {
        return (ɵZonelessPlugin_BaseFactory || (ɵZonelessPlugin_BaseFactory = ɵɵgetInheritedFactory(_ZonelessPlugin)))(t || _ZonelessPlugin);
      };
    })();
  }
  static {
...
var PLUGINS = [SilentEventPlugin, ZonelessPlugin, GlobalEventPlugin, OptionsEventPlugin, PreventEventPlugin, ResizePlugin, SelfEventPlugin, StopEventPlugin, LongtapEventPlugin];
...
//# sourceMappingURL=chunk-6HW5XFU2.js.map
